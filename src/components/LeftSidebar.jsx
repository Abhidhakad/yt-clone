    ...
    <>
      ...
      >
        ...
        <ul className="px-4 pt-2 space-y-1">
          <li className="flex gap-4 px-2 py-2 items-center justify-items-start bg-gray-300 hover:shadow-2xl rounded-2xl">
            <MdHome className="text-[28px]" />
            <p className="text-md font-medium">Home</p>
          </li>

          <li className="flex gap-4 px-2 py-2 items-center justify-items-start hover:bg-gray-300 hover:shadow-2xl hover:rounded-2xl">
            <SiYoutubeshorts className="text-[26px]" />
            <p className="text-md font-normal">Shorts</p>
          </li>
